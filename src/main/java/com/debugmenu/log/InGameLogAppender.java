 ...
 *
 * <p>该 Appender 挂在 Log4j2 的 Root Logger 上，会捕获所有模组（包括本模组之外）
 * 打到 Log4j2 的日志。玩家可通过调试菜单里的“聊天框日志显示”开关随时开关，
 * 并通过“日志最低级别”选项调整过滤级别。
 */
public class InGameLogAppender extends AbstractAppender {

    /** 是否启用（玩家可通过调试菜单开关切换）。默认开启。 */
    ...
    public InGameLogAppender() {
        super("DebugMenuInGameLogAppender", null, PatternLayout.createDefaultLayout(), true, Property.EMPTY_ARRAY);
    }
